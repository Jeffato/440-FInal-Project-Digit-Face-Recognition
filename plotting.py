...
plt.xlabel('Data Point Percent')
plt.ylabel('Training Time')
plt.title('Training Time vs Data Point Percentage')
...
plt.title('prediction error vs Data Point Percentage')
plt.grid(True, axis="both")
plt.legend()
plt.show()
...
plt.title('standard deviation vs Data Point Percentage')
plt.grid(True, axis="both")
plt.legend()
plt.show()